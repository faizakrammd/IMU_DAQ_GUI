...
class OpenGLBox(QOpenGLWidget):
    ...
    def paintGL(self):
        ...
        # Draw a CubeSat-like structure
        self.draw_cubesat()

    def draw_cubesat(self):
        # Central body
        glBegin(GL_QUADS)
        glColor3f(0.0, 0.0, 0.0)  # Black color for central body
        ...
        # Solar panels (extend from sides)
        glBegin(GL_QUADS)
        glColor3f(0.0, 0.0, 0.6)  # Less shiny blue for solar panels
        glVertex3f(-0.7, -0.3, 0.6)
        glVertex3f(-0.7, 0.3, 0.6)
        glVertex3f(-1.3, 0.3, 0.6)
        glVertex3f(-1.3, -0.3, 0.6)
...
class SerialMonitor(QWidget):
    def __init__(self):
        ...
        # GUI setup
        self.setWindowTitle("CubeSat Command Center")
        self.setGeometry(100, 100, 1200, 800)

        self.layout = QGridLayout()

        # Header label
        self.header_label = QLabel("CubeSat Command Center", self)
        self.header_label.setStyleSheet("font-size: 24px; font-weight: bold;")
        self.layout.addWidget(self.header_label, 0, 0, 1, 2, alignment=Qt.AlignCenter)
        ...
        self.layout.addWidget(self.roll_label, 1, 0)
        self.layout.addWidget(self.pitch_label, 1, 1)
        self.layout.addWidget(self.opengl_widget, 2, 0, 1, 2)
        self.layout.addWidget(self.chart_view, 3, 0, 1, 2)
        ...
        # Data storage
        self.data = []
        self.max_points = 150  # Keep only the most recent 150 points in the graph
